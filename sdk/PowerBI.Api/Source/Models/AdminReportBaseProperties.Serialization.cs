...
{
    public partial class AdminReportBaseProperties : IUtf8JsonSerializable
    {
        ...
        internal static AdminReportBaseProperties DeserializeAdminReportBaseProperties(JsonElement element)
        {
            ...
            return new AdminReportBaseProperties(
                id,
                name,
                datasetId,
                appId,
        ...
        internal static AdminReportBaseProperties FromResponse(Response response)
        {
            using var document = JsonDocument.Parse(response.Content);
            return DeserializeAdminReportBaseProperties(document.RootElement);
        }
