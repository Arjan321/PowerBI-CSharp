...
namespace Microsoft.PowerBI.Api.Models
{
    ...
    public partial class AdminReportBaseProperties
    {
        /// <summary> Initializes a new instance of <see cref="AdminReportBaseProperties"/>. </summary>
        /// <param name="id"> The report ID. </param>
        public AdminReportBaseProperties(Guid id)
        {
            Id = id;
        }
        ...
        /// </param>
        internal AdminReportBaseProperties(Guid id, string name, string datasetId, string appId, string description, AdminReportBasePropertiesReportType? reportType, Guid? originalReportId, bool? isOwnedByMe, string format)
        {
            Id = id;
            Name = name;
            DatasetId = datasetId;
        ...
        public AdminReportBasePropertiesReportType? ReportType { get; set; }
